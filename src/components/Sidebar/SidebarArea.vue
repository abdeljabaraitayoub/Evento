...
`,
      ...
      {
        icon: `<i class="bi bi-calendar4-event"></i>
`,
        label: 'Events',
        ...
        <template v-for="menuGroup in menuGroups" :key="menuGroup.name">
          ...
          <div>
            ...
            <ul class="mb-6 flex flex-col gap-1.5">
              <li>
                <a
                  class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 bg-graydark dark:bg-meta-4"
                  ><button @click="logout">
                    <svg
                      class="fill-current"
                      width="18"
