        ...
        <div class="col-lg-12 col-md-12">
          <div class="checkout-block">
            <div class="main-card mt-5">
              <div class="bp-title">
                <h4>Total Payable Amount : AUD $10.00</h4>
              </div>
                  ...
                  <form @submit.prevent="handlePayment">
                    <div class="col-lg-12 col-md-12">
                      <div class="form-group mt-4">
                        ...
                        <div id="card-number" class="form-control h_50 stripe-element"></div>
                    ...
                    <div class="col-lg-6 col-md-12">
                      <div class="form-group mt-4">
                        ...
                        <div id="card-expiry" class="form-control h_50 stripe-element"></div>
                        <!-- Stripe Element mounts here -->
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                      <div class="form-group mt-4">
                        ...
                        <div id="card-cvc" class="form-control h_50 stripe-element"></div>
                        <!-- Stripe Element mounts here -->
                      </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
...
import api from '@/stores/api' // Ensure this path is correct for your project structure
...
export default {
  ...
  async mounted() {
    this.stripe = await loadStripe(
      'pk_test_51OgSUxHMAG246xoVivCD9I7wq9F8Kvjr5twxGT56ZMokB5v1VUX3WfBh0Am0nNqPRLwkr4cU26t0eOMHKXpE35wN00PbDRxJ9w'
    )
  ...
  methods: {
    ...
    handlePayment() {
      this.stripe
        .createPaymentMethod({
          type: 'card',
          card: this.elements.getElement('cardNumber') // We use only cardNumber but Stripe Elements associates it with the other elements
        })
    ...
    processPayment(paymentMethodId) {
      api
        .post('/payment', { paymentMethodId })
        .then(() => {
          alert('Payment successful!')
          api.post('/reservations', { event_id: this.$route.params.id }).then((response) => {
            alert(response.data.message)
          })
        })
        .catch((error) => {
          alert(`Payment processing error: ${error.response.data.message}`)
        })
    }
  }
}
