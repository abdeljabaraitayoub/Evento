...
export default {
  ...
  methods: {
    fetchEvent() {
      api.get(`/events/${this.id}`).then((response) => {
            ...
            >
              ...
              <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe_5">
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link" href="/auth/signin" role="button"> Login </a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
              <div class="event-top-dts">
                <div class="event-top-dt">
                  <h3 class="event-main-title">{{ this.event.title }}</h3>
                  <div class="event-top-info-status">
                    <span class="event-type-name"
                      ><i class="fa-solid fa-video"></i>Online Event</span
                    >
                    <span class="event-type-name details-hr"
                      >Starts on
                      <span class="ev-event-date">{{ this.event.start_date }}</span></span
                    >
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-8 col-lg-7 col-md-12">
              <div class="main-event-dt">
                ...
                <div class="main-event-content">
                  ...
                  <p>
                    In malesuada luctus libero sed gravida. Suspendisse nunc est, maximus vel
                    viverra nec, suscipit non massa. Maecenas efficitur vestibulum pellentesque. Ut
                    finibus ullamcorper congue. Sed ut libero sit amet lorem venenatis facilisis.
                    Mauris egestas tortor vel massa auctor, eget gravida mauris cursus. Etiam
                    elementum semper fermentum. Suspendisse potenti. Morbi lobortis leo urna, non
                    laoreet enim ultricies id. Integer id felis nec sapien consectetur porttitor.
                    Proin tempor mauris in odio iaculis semper. Cras ultricies nulla et dui viverra,
                    eu convallis orci fermentum.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-12">
              <div class="main-card event-right-dt">
                ...
                <div class="event-dt-right-group">
                  ...
                  <div class="event-dt-right-content">
                    <h4>Location</h4>
                    <h5 class="mb-0">{{ this.event.location }}</h5>
                  </div>
                </div>
                <div class="event-dt-right-group">
                  <div class="event-dt-right-icon">
                  ...
                  <div class="event-dt-right-content">
                    <h4>AUD</h4>
                    <h5 class="mb-0">{{ this.event.price }}</h5>
                  </div>
                </div>
                <div class="booking-btn">
                  <router-link class="main-btn btn-hover w-100" :to="`/payment/${this.id}`"
          ...
          <div class="row">
            <div class="col-12">
              <div class="footer-copyright-text">
                <p class="mb-0">
                  © 2024, <strong>Barren</strong>. All rights reserved. Powered by Gambolthemes
                </p>
              </div>
            </div>
          </div>
...
.hero-banner {
  background-image: url(https://www.gambolthemes.net/html-items/barren-html/disable-demo-link/@/assets/images/banner.jpg);
...
.app-form-sidebar {
  ...
  min-height: 100vh;
  background: #6ac045
    url(https://www.gambolthemes.net/html-items/barren-html/disable-demo-link/@/assets/images/sign_bg.jpg);
  width: 500px;
  padding: 50px;
}
...
.hero-cover-img {
  ...
  position: absolute;
  inset: 0px;
  background-image: url(https://www.gambolthemes.net/html-items/barren-html/disable-demo-link/@/assets/images/banners/hero-cover-01.jpg);
  filter: none;
  transition: all 0.12s ease-in-out 0s;
  opacity: 1;
}
...
.subscription-bg {
  background: url(https://www.gambolthemes.net/html-items/barren-html/disable-demo-link/@/assets/images/banners/subscription-bg.png)
...
.upgrade-content .upgrade-premium-center {
  ...
  background-image: url(https://www.gambolthemes.net/html-items/barren-html/disable-demo-link/@/assets/images/banners/up-shape.png);
  background-repeat: no-repeat;
...
.contact-hero-banner {
  min-height: 461px;
  background: url(https://www.gambolthemes.net/html-items/barren-html/disable-demo-link/@/assets/images/sign_bg.jpg);
  width: 100%;
  padding: 50px;
  border-radius: 3px;
}
