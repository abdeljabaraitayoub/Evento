...
export default {
  ...
  mounted() {
    this.fetchEvents(), this.fetchCategories()
  },
  methods: {
    fetchEvents() {
      api
        .get(
          `/events?page=${this.page}&category=${this.category}&event=${this.search}&date=${this.date}&region=${this.region}`
        )
        .then((response) => {
...
<template>
  <html lang="en" class="h-100 night-mode">
    <!-- Mirrored from www.gambolthemes.net/html-items/barren-html/disable-demo-link/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Mar 2024 12:55:49 GMT -->
              ...
              <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="event-filter-items">
                  <div class="featured-controls">
                    ...
                    <div class="filter-tag">
                      ...
                      >
                        ...
                        <option v-for="item in categories" v-bind="item.id" :value="item.id">
                          {{ item.name }}
                        </option></select
                      ><select
                        v-model="date"
                      ...
                      >
                        <div class="main-card mt-4">
                          ...
                          <div class="event-content">
                            <router-link :to="`/events/${event.id}`" class="event-title">{{
                              event.title
                            }}</router-link>
                            <div class="duration-price-remaining">
                              <span class="duration-price">Dollar ${{ event.price }}*</span>
                          ...
                          <div class="event-footer">
                            <div class="event-timing">
                              ...
                              <span class="publish-time"
                                ><i class="fa-solid fa-clock me-2"></i>{{ event.capacity }}</span
                              >
                            </div>
                          </div>
                        </div>
                  ...
                  <nav aria-label="Page navigation example">
                    <ul class="pagination filter-tag">
                      <li class="page-item"></li>
                      <!-- eslint-disable-next-line vue/require-v-for-key -->
                      <li v-for="link in pagination.links" class="page-item">
                        <a @click="page = link.label" class="page-link" v-html="link.label"> </a>
                      </li>
                    </ul>
                  </nav>
                </div>
...
.hero-banner {
  background-image: url(https://www.gambolthemes.net/html-items/barren-html/disable-demo-link/images/banner.jpg);
...
.app-form-sidebar {
  ...
  min-height: 100vh;
  background: #6ac045
    url(https://www.gambolthemes.net/html-items/barren-html/disable-demo-link/images/sign_bg.jpg);
  width: 500px;
  padding: 50px;
}
...
.hero-cover-img {
  ...
  position: absolute;
  inset: 0px;
  background-image: url(https://www.gambolthemes.net/html-items/barren-html/disable-demo-link/images/banners/hero-cover-01.jpg);
  filter: none;
  transition: all 0.12s ease-in-out 0s;
  opacity: 1;
}
...
.subscription-bg {
  background: url(https://www.gambolthemes.net/html-items/barren-html/disable-demo-link/images/banners/subscription-bg.png)
...
.upgrade-content .upgrade-premium-center {
  ...
  background-image: url(https://www.gambolthemes.net/html-items/barren-html/disable-demo-link/images/banners/up-shape.png);
  background-repeat: no-repeat;
...
.contact-hero-banner {
  min-height: 461px;
  background: url(https://www.gambolthemes.net/html-items/barren-html/disable-demo-link/images/sign_bg.jpg);
  width: 100%;
  padding: 50px;
  border-radius: 3px;
}
