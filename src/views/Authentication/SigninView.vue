          ...
          <div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
            ...
            <main>
              <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
                <!-- Breadcrumb Start --><!-- Breadcrumb End --><!-- ====== Forms Section Start -->
                <div
                  class="mt-30 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark"
                >
                    ...
                    <div class="hidden w-full xl:block xl:w-1/2">
                      <div class="py-17.5 px-26 text-center">
                        ...
                        <span class="mt-15 inline-block"
                          ><img
                            src="/src/assets/images/illustration/illustration-03.svg"
                            alt="illustration"
                        /></span>
                      </div>
                    </div>
                        ...
                        <form>
                          ...
                          <div class="mt-6 text-center">
                            <p class="font-medium">
                              ...
                              <a href="/auth/signup" class="text-primary">Sign up</a>
                            </p>
                          </div>
                          <div class="mt-6 text-center">
                            <p class="font-medium">
                              Forget Password?
                              <a href="/auth/resetpassword" class="text-primary">Reset</a>
                            </p>
                          </div>
                        </form>
                      </div>
