                        ...
                        <form>
                            ...
                            <div class="mb-4 mt-4">
                              ...
                              <div class="relative z-20 bg-white dark:bg-form-input">
                                ...
                                >
                                  ...
                                  <option class="text-body dark:text-bodydark" value="user">
                                    user
                                  </option>
                                  <option class="text-body dark:text-bodydark" value="organizer">
                                    Organizer
                                  </option></select
                          ...
                          <div class="mt-6 text-center">
                            <p class="font-medium">
                              ...
                              <a href="/auth/signin" class="text-primary">Sign in</a>
                            </p>
                          </div>
                        </form>
                      </div>
